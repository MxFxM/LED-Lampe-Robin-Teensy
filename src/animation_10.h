...
//                                                   left, right
float scaling3d[] = {1, 0.9, 0.7, 0.6, 0.5, 0.3, 0.2, 0.1, 0.1, 0.2, 0.3, 0.5, 0.6, 0.7, 0.9, 1};
float hue_10 = 0.0;
...
void run_animation_10(RgbColor ledarray[NUMPIXELS], float bins[NUMBER_OF_STRIPES], int stripe_offsets[NUMBER_OF_STRIPES + 1], float stripe_maximums[NUMBER_OF_STRIPES])
{
    // prepare the color
    HsvColor hsvcol;
